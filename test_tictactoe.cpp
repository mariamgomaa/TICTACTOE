...
TEST(GameLogicTest, MakeMove_OutOfBounds) {
    TicTacToeGame game;
    bool result = game.makeMove(3, 0, HUMAN); // Board size is 3x3, so index 3 is out
    EXPECT_FALSE(result);
}
...
TEST(MinimaxTest, DrawScore) {
    ...
    game.makeMove(0,0, HUMAN); game.makeMove(0,1, AI);    game.makeMove(0,2, HUMAN);
    game.makeMove(1,0, AI);    game.makeMove(1,1, HUMAN); game.makeMove(1,2, AI);
    game.makeMove(2,0, AI);    game.makeMove(2,1, HUMAN); game.makeMove(2,2, AI);
