...
>>>>>>> Merna
                 /// @brief Manages user authentication, session control, and
                 /// data persistence.
>>>>>>> 2cb39a158de34bd848a6f2e8c8e460bfe63ddc37
    class UserManager {
  == == ==
      =
          /// @brief Handles all user-related operations including
          /// authentication, data persistence, and game history management.
      class UserManager {
>>>>>>> Merna
   public:
