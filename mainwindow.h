...
public:
    ...
    ~MainWindow();
    void testShowLoginScreen() { showLoginScreen(); }
    void testShowRegisterScreen() { showRegisterScreen(); }
    void testShowUserProfile() { showUserProfile(); }
    void testShowGameSetup() { showGameSetup(); }
    void testShowPlayerNamesInput() { showPlayerNamesInput(); }
    void testShowGame() { showGame(); }
    void testShowGameHistory() { showGameHistory(); }
    void testShowGameReplay() { showGameReplay(); }
    void testNewGame() { newGame(); }
    void testStartGameSetup() { startGameSetup(); }
    void testResetBoard() { resetBoard(); }
    void testCheckGameEnd() { checkGameEnd(); }
    void testUpdateUserStats(bool won, bool lost, bool tied) {
        updateUserStats(won, lost, tied);
    }

    void testRecordGameMove(int row, int col, int player) {
        recordGameMove(row, col, player);
    }

    void testRecordGameResult(const QString &result, const QString &opponent,
                              const QString &gameMode, const QString &playerSymbol) {
        recordGameResult(result, opponent, gameMode, playerSymbol);
    }

    void testUpdateUserProfileDisplay() {
        updateUserProfileDisplay();
    }

    void testUpdateGameHistoryDisplay() {
